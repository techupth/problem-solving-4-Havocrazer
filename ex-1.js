...
const result1 = pivotIndex([1, 7, 3, 6, 5, 6]);
const result2 = pivotIndex([1, 2, 3]);
const result3 = pivotIndex([2, 1, -1]);
const result4 = pivotIndex([1, 8, 4, 6, 7, 6]);
